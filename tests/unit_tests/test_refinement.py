...
def test_refinement_method_subpixel(cv_dataset):
    ...
    dataset_disp_map = common.dataset_disp_maps(data, data, cost_volumes_test.coords, data)
...
def test_refinement_method_pixel(cv_dataset):
    ...
    dataset_disp_map = common.dataset_disp_maps(gt_delta_y, gt_delta_x, cost_volumes_test.coords, gt_delta_x)
