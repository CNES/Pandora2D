...
The phase cross correlation method depends on the frequency domain.
...
.. warning::
    ...
    The estimated shifts (``estimated_shifts``, ``phase_diff``, ``error``) written into the output configuration
